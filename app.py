...
from youtubesearchpython import VideosSearch, Playlist, Video, StreamURLFetcher, ResultMode, CustomSearch, SearchMode
...
# POST: Scrape YouTube Playlist
@app.route("/api/playlist/", methods=['POST'])
def get_playlist():
    pass

# POST: Scrape YouTube Video
